...
class _QuestionsAnswersState extends State<QuestionsAnswers> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     body: FutureBuilder<Map<String,dynamic>?>(future: sendQuestionData(widget.jobdescription,widget.jobrequirements,
         widget.level,widget.emailid),  builder: (context,snapshot) {
