...
class _HomePageState extends State<HomePage> {
    ...
    return  Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color:buttonColor.withOpacity(0.3),borderRadius: BorderRadius.only(topRight: Radius.circular(30))),
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(emoji, style:GoogleFonts.poppins(
                  color: Colors.black,
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Text(date, style:GoogleFonts.sora(
                        color: Colors.black,
                        fontWeight: FontWeight.w400,
                        fontSize:13,
                      ),),
                      SizedBox(width: size.width*0.02,),
                      Text(time, style:GoogleFonts.sora(
                        color: Colors.black,
                        fontWeight: FontWeight.w400,
                        fontSize:13,
                      ),),
            ...
            Expanded(
              child: Padding(
                ...
                child: Text(role, style:GoogleFonts.sora(
                  color: Colors.white,
                  fontWeight: FontWeight.w600,
                  fontSize:18,
                ),),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text("Average Score:", style:GoogleFonts.sora(
                    color: Colors.black,
                    fontWeight: FontWeight.w600,
                    fontSize:13,
                  ),),
  ...
  Widget build(BuildContext context) {
    var size=MediaQuery.of(context).size;
    return Scaffold(
      appBar: PreferredSize(preferredSize: Size.fromHeight(size.height*0.09),
      child: AppBar(
        // centerTitle:true,
        elevation: 3,
              ...
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    Text("Stimulate real interviews!", style:GoogleFonts.sora(
                      color: Colors.white,
                      fontWeight: FontWeight.w600,
                      fontSize:18,
                    ),),
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 19.0),
                  child: Text("Analyze your interview skills with AI", textAlign: TextAlign.center,
                    style:GoogleFonts.sora(
                    color: Colors.white,
                    fontWeight: FontWeight.w600,
                    fontSize:13,
...
Navigator.push(context, MaterialPageRoute(builder: (context)=>RoleDescription()));
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20.0,vertical: 10),
            child: Text("Past Interviews", style:GoogleFonts.poppins(
              color: Colors.black,
              fontWeight: FontWeight.w700,
              fontSize: 20,
            ),),
          ),
          PastInterviews("Software Developer Engineer", "Mar 9,2024", "11:13pm", 5.9),
SizedBox(height: 10,)
        ],
      ),
    );
